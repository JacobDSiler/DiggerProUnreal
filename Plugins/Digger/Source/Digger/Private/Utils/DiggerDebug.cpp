...
FDiggerDebug::FDiggerDebug()
{
	...
	RegisterFlag(TEXT("SmartTrace"), SmartTrace);
}
...
void FDiggerDebug::DrawTraceSegment(
	UWorld* World,
	const FVector& Start,
	const FVector& End,
	const FColor& Color,
	float Duration)
{
	...
	DrawDebugSphere(World, Start, 8.0f, 12, Color, false, Duration);
	DrawDebugSphere(World, End,   8.0f, 12, Color, false, Duration);
}
