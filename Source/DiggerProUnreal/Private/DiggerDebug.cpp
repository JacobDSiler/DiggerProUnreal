...
TArray<DiggerDebug::FDiggerDebugFlag> DiggerDebug::GetAllFlags()
{
	TArray<DiggerDebug::FDiggerDebugFlag> OutFlags;
	for (const auto& Pair : GetFlagRegistry())
	{
		OutFlags.Emplace(Pair.Key, Pair.Value);
	}
	return OutFlags;
}
